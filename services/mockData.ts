...
import { Employee, EmployeeRank, Job, JobGroup, Role, Status, TimeFrame, ScheduleItem, SchedulePattern, WorkPeriod, Holiday, SubJob } from "../types";
...
export const initialEmployees: Employee[] = [
    {
        ...
        rank: EmployeeRank.A,
        jobGroups: [JobGroup.Training, JobGroup.Livechat, JobGroup.Daily],
...
export const initialJobs: Job[] = [
    { id: 'job_1', name: 'A', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 1.5, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_2', name: 'B', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 1.5, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_3', name: 'C', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 1.5, durationMinutes: 180, difficulty: 1, isActive: false }, // Ngưng
    { id: 'job_4', name: 'D', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 1.5, durationMinutes: 180, difficulty: 1, isActive: false }, // Ngưng
    { id: 'job_5', name: 'AMIS XD', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.75, durationMinutes: 210, difficulty: 1, isActive: true },
    { id: 'job_6', name: 'AMIS CB', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 2, durationMinutes: 210, difficulty: 1, isActive: true },
    { id: 'job_7', name: 'AMIS SX', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.9, durationMinutes: 210, difficulty: 2, isActive: true },
    { id: 'job_8', name: 'AMIS TM', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.8, durationMinutes: 210, difficulty: 1, isActive: true },
    { id: 'job_9', name: 'SME DV', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.75, durationMinutes: 210, difficulty: 1, isActive: true },
    { id: 'job_10', name: 'AMIS CB - TOI', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 3, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_11', name: 'AMIS DV', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.75, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_12', name: 'SME CB - TOI', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 3, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_13', name: 'AMIS CĐ', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 0.8, durationMinutes: 120, difficulty: 1, isActive: true },
    { id: 'job_14', name: 'SME TM', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.8, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_15', name: 'SME XD', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.75, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_16', name: 'SME SX', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.9, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_17', name: 'SME GT - TOI', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 3.6, durationMinutes: 180, difficulty: 2, isActive: true },
    { id: 'job_18', name: 'AMIS SX - TOI', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 3.3, durationMinutes: 180, difficulty: 2, isActive: true },
    { id: 'job_19', name: 'AMIS CT - TOI', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.8, durationMinutes: 180, difficulty: 2, isActive: true },
    { id: 'job_20', name: 'HTX', group: JobGroup.Training, classification: 'Lĩnh vực', standardPoint: 1.8, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_21', name: 'TRUC_LIVECHAT', group: JobGroup.Livechat, standardPoint: 2, durationMinutes: 240, difficulty: 1, isActive: true },
    { id: 'job_22', name: 'TN_LIVECHAT', group: JobGroup.Livechat, standardPoint: 2, durationMinutes: 240, difficulty: 1, isActive: true },
    { id: 'job_23', name: 'ĐT TRUC TIEP', group: JobGroup.Other, standardPoint: 8, durationMinutes: 0, difficulty: 1, isActive: true },
    { id: 'job_24', name: 'ĐT_NOIBO', group: JobGroup.Other, standardPoint: 8, durationMinutes: 0, difficulty: 1, isActive: false },
    { id: 'job_25', name: 'AMIS_SME TV', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 1, durationMinutes: 180, difficulty: 1, isActive: true },
    { id: 'job_26', name: '1-1', group: JobGroup.Daily, standardPoint: 0, durationMinutes: 0, difficulty: 1, isActive: true },
    { id: 'job_27', name: 'Chuyển đổi', group: JobGroup.Daily, standardPoint: 0, durationMinutes: 0, difficulty: 1, isActive: true },
    // Add missing job from new requirement
    { id: 'job_28', name: 'AMIS_KETNOI', group: JobGroup.Training, classification: 'Nghiệp vụ', standardPoint: 1, durationMinutes: 90, difficulty: 1, isActive: true },
];
